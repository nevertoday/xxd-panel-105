<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 105" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 105｜مختارات الفراغ الشعري

### احتفظ باللحظة الأجدر بالذاكرة، واجعل الحذف نفسه هو التصميم
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 105 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## الحالات المناسبة والمشكلات التي يحلها

أحياناً لا تكمن القيمة الحقيقية للصورة في كل ما تحتويه، بل في وضعية أو علاقة أو لحظة واحدة نريد للذاكرة أن تحتفظ بها. يحوّل **Panel 105** هذا النوع من الصور إلى مقتطف بصري هادئ ورفيع: يحدد ما يستحق البقاء، ثم يعيد بناءه بقصاصات الورق والكتل اللونية والفراغ وملمس الطباعة، من دون نقل الصورة آلياً إلى رسم.

### مناسب عندما

- **تكون الصورة مزدحمة لكن شعورها أهم من تفاصيلها:** يختار موضوعاً مركزياً واحداً وأقل عدد ممكن من العناصر المساندة التي تحمل الذكرى.
- **تحتاج إلى ملصق أو غلاف يتنفس:** يستخدم مركزاً بصرياً واحداً ومساحات واسعة من بياض الورق لصنع إيقاع بين الموضوع والنص والصمت.
- **تريد ملمس الورق الحقيقي لا النعومة الرقمية:** يحتفظ بحواف القص والتمزيق والحبيبات ونقص الطباعة والفرك الجاف وتفاوت الحبر والانزياح الطفيف في التسجيل.
...
- لا يملأ التكوين بخلفيات مزدحمة أو أشياء متكررة أو تفاصيل بلا قيمة سردية.
- لا تحتاج إلى اتخاذ كل قرار إبقاء أو حذف بنفسك؛ ينتقي النموذج وفق الجمال والحضور وسهولة التعرّف والقيمة التكوينية.
- لا تؤخذ الألوان بالتساوي، بل تُحفظ العلاقات الأكثر رسوخاً في الذاكرة وتُنقّى في لوحة محدودة ناعمة ومضيئة ومتجانسة.

### بداية سريعة

> استخدم XXD Panel 105 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** انتقاء جمالي ذكي · بساطة شعرية · كولاج ورقي · مركز بصري واحد · فراغ سلبي واسع · ملمس الطباعة الأحادية／الشاشة الحريرية／Risograph · لوحة محدودة ناعمة
...
|---|---|
| **الناتج** | ملصق ورقي شعري يشبه «مقتطفاً من الذاكرة»، ولا يحتفظ إلا بما يحمل الجمال والقيمة السردية |
| **البصمة الواضحة** | مركز بصري واحد، وبياض ورقي واسع، وكتل من الورق المقصوص، وحواف غير منتظمة، وحبيبات، وانزياح طفيف في التسجيل |
| **احترام المصدر** | تبقى الهوية والبنية والوضع والعلاقة المركزية واضحة؛ الذي يتغير هو كثافة المعلومات وتنظيمها البصري |
...
```text
العثور على أجمل لحظة → إبقاء موضوع مركزي واحد → حذف المعلومات العادية والمتكررة → الاختزال إلى قصاصات ورق وكتل لونية وهندسة بسيطة → إعادة البناء بالقص والتمزيق والتراكب → إكمال «مقتطف الذاكرة» ببياض الورق وحبيبات الطباعة والملاحظات الهامسة
```

## سمات النتيجة النهائية

- تختزل الصورة إلى مركز بصري واحد مع أقل عدد من العناصر المساندة، ويتحول ما عداها إلى فراغ فعّال.
- تحافظ قصاصات الورق والكتل اللونية والهندسة البسيطة على وضوح الموضوع ووضعه وعلاقته المركزية.
- تمنح mixed-media collage وcut-paper collage وmonoprint وscreen print وRisograph-inspired texture السطح ملمساً ورقياً.
- تأتي الألوان من أجمل علاقات الأصل وأكثرها رسوخاً في الذاكرة، وتُنظّم في لون رئيسي ومساعد ومميّز ومساحات واسعة من بياض الورق.
- تعمل الكلمات القليلة كملاحظات هامسة في منشور فني؛ ويُتجنب بناء المشهد كاملاً وملء الخلفية وتكديس التفاصيل والتحويل إلى كرتون وطابع الرسوم التجارية والنتائج القالبية.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-105-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 105. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-105 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-105 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-105 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-105 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-105 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 105 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-105 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-105`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-105-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-105-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ105 على موجّهه الأصلي ومنطقه الجمالي المستقل. يعرض الجدول روابط جميع المشاريع وخصائص أسلوبها الأساسية، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–105) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
